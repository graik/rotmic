...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RatedComment'
        db.create_table(u'ratedcomments_ratedcomment', (
        ...
        db.send_create_signal(u'ratedcomments', ['RatedComment'])


    def backwards(self, orm):
        # Deleting model 'RatedComment'
        db.delete_table(u'ratedcomments_ratedcomment')
    ...
    models = {
        ...
        u'ratedcomments.ratedcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'RatedComment', '_ormbases': [u'django_comments.Comment']},
