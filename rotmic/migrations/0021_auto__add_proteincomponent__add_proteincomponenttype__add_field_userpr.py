...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_proteincomponent', (
            ...
            ('componentType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ProteinComponentType'])),
        ))
        db.send_create_signal('rotmic', ['ProteinComponent'])

        # Adding model 'ProteinComponentType'
        db.create_table(u'rotmic_proteincomponenttype', (
            ...
            ('subTypeOf', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subTypes', null=True, to=orm['rotmic.ProteinComponentType'])),
        ))
        db.send_create_signal('rotmic', ['ProteinComponentType'])

        # Adding field 'UserProfile.pcPrefix'
        db.add_column(u'rotmic_userprofile', 'pcPrefix',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'rotmic_proteincomponent')

        # Deleting model 'ProteinComponentType'
        db.delete_table(u'rotmic_proteincomponenttype')

        # Deleting field 'UserProfile.pcPrefix'
        db.delete_column(u'rotmic_userprofile', 'pcPrefix')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
        ...
        'rotmic.proteincomponent': {
            ...
            'componentType': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.ProteinComponentType']"}),
            u'component_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rotmic.Component']", 'unique': 'True', 'primary_key': 'True'}),
            'genbank': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sequence': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'planning'", 'max_length': '30'})
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
