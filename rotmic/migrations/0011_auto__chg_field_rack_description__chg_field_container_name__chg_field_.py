...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rack.description'
        db.alter_column(u'rotmic_rack', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Container.name'
        db.alter_column(u'rotmic_container', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Location.description'
        db.alter_column(u'rotmic_location', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Rack.description'
        db.alter_column(u'rotmic_rack', 'description', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Container.name'
        db.alter_column(u'rotmic_container', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Location.description'
        db.alter_column(u'rotmic_location', 'description', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
        ...
        'rotmic.container': {
            'Meta': {'ordering': "('displayId',)", 'unique_together': "(('displayId', 'rack'),)", 'object_name': 'Container'},
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'rack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.Rack']"}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
        ...
        'rotmic.rack': {
            'Meta': {'ordering': "('displayId',)", 'unique_together': "(('displayId', 'location'),)", 'object_name': 'Rack'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'displayId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.Location']", 'null': 'True', 'blank': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
