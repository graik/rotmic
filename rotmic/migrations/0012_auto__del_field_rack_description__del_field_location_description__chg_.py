...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rotmic_rack', 'description')

        # Deleting field 'Location.description'
        db.delete_column(u'rotmic_location', 'description')


        # Changing field 'Location.temperature'
        db.alter_column(u'rotmic_location', 'temperature', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Adding field 'Rack.description'
        db.add_column(u'rotmic_rack', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.description'
        db.add_column(u'rotmic_location', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Location.temperature'
        db.alter_column(u'rotmic_location', 'temperature', self.gf('django.db.models.fields.FloatField')(default=None))
