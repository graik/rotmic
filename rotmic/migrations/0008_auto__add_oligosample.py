...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OligoSample'
        db.create_table(u'rotmic_oligosample', (
            (u'sample_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rotmic.Sample'], unique=True, primary_key=True)),
            ('oligo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='oligo_samples', to=orm['rotmic.OligoComponent'])),
        ))
        db.send_create_signal('rotmic', ['OligoSample'])


    def backwards(self, orm):
        # Deleting model 'OligoSample'
        db.delete_table(u'rotmic_oligosample')
