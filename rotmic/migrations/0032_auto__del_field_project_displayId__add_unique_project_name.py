...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.displayId'
        db.delete_column(u'rotmic_project', 'displayId')

        # Adding unique constraint on 'Project', fields ['name']
        db.create_unique(u'rotmic_project', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['name']
        db.delete_unique(u'rotmic_project', ['name'])


        # User chose to not deal with backwards NULL issues for 'Project.displayId'
        raise RuntimeError("Cannot reverse this migration. 'Project.displayId' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.displayId'
        db.add_column(u'rotmic_project', 'displayId',
