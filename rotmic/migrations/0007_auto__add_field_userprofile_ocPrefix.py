...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.ocPrefix'
        db.add_column(u'rotmic_userprofile', 'ocPrefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.ocPrefix'
        db.delete_column(u'rotmic_userprofile', 'ocPrefix')
