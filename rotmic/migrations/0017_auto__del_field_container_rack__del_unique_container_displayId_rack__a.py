...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'rotmic_container', 'rack',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rotmic.Rack']),
                      keep_default=False)
    ...
    models = {
        ...
        'rotmic.container': {
            'Meta': {'ordering': "('displayId',)", 'unique_together': "(('displayId',),)", 'object_name': 'Container'},
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
