...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_sampleprovenance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sampleProvenance', to=orm['rotmic.Sample'])),
            ('sourceSample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='derivedSample', null=True, to=orm['rotmic.Sample'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('provenanceType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.SampleProvenanceType'])),
        ))
        db.send_create_signal('rotmic', ['SampleProvenance'])

        # Adding model 'SampleProvenanceType'
        db.create_table(u'rotmic_sampleprovenancetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, blank=True)),
            ('requiresSource', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('isDefault', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('rotmic', ['SampleProvenanceType'])

        # Adding M2M table for field provenance on 'Sample'
        m2m_table_name = db.shorten_name(u'rotmic_sample_provenance')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sample', models.ForeignKey(orm['rotmic.sample'], null=False)),
            ('sampleprovenance', models.ForeignKey(orm['rotmic.sampleprovenance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sample_id', 'sampleprovenance_id'])


    def backwards(self, orm):
        # Deleting model 'SampleProvenance'
        db.delete_table(u'rotmic_sampleprovenance')

        # Deleting model 'SampleProvenanceType'
        db.delete_table(u'rotmic_sampleprovenancetype')

        # Removing M2M table for field provenance on 'Sample'
        db.delete_table(db.shorten_name(u'rotmic_sample_provenance'))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
        ...
        'rotmic.sampleprovenance': {
            ...
            'sample': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sampleProvenance'", 'to': "orm['rotmic.Sample']"}),
            'sourceSample': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'derivedSample'", 'null': 'True', 'to': "orm['rotmic.Sample']"})
        },
