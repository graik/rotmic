...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_attachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('f', self.gf('rotmic.utils.filefields.DocumentModelField')(max_length=100)),
        ...
        db.send_create_signal('rotmic', ['Attachment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'rotmic_attachment')
    ...
    models = {
        ...
        'rotmic.attachment': {
            ...
            'f': ('rotmic.utils.filefields.DocumentModelField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rotmic.component': {
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 2, 0, 0)'}),
