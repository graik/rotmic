...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DnaSequenceFeature'
        db.create_table(u'rotmic_dnasequencefeature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ...
            ('component', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequenceFeatures', to=orm['rotmic.DnaComponent'])),
        ))
        db.send_create_signal('rotmic', ['DnaSequenceFeature'])

        # Adding model 'DnaSequenceLink'
        db.create_table(u'rotmic_dnasequencelink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('strand', self.gf('django.db.models.fields.CharField')(default='+', max_length=1)),
            ('component', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequenceLinks', to=orm['rotmic.DnaComponent'])),
            ('subComponent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='linkedVia', null=True, to=orm['rotmic.DnaComponent'])),
            ('hardLink', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('rotmic', ['DnaSequenceLink'])

        # Adding model 'ProteinSequenceFeature'
        db.create_table(u'rotmic_proteinsequencefeature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('strand', self.gf('django.db.models.fields.CharField')(default='+', max_length=1)),
            ...
            ('featureType', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('component', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequenceFeatures', to=orm['rotmic.ProteinComponent'])),
        ))
        db.send_create_signal('rotmic', ['ProteinSequenceFeature'])


    def backwards(self, orm):
        # Deleting model 'DnaSequenceFeature'
        db.delete_table(u'rotmic_dnasequencefeature')

        # Deleting model 'DnaSequenceLink'
        db.delete_table(u'rotmic_dnasequencelink')

        # Deleting model 'ProteinSequenceFeature'
        db.delete_table(u'rotmic_proteinsequencefeature')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 4, 0, 0)', 'blank': 'True'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 4, 0, 0)'}),
        ...
        'rotmic.dnasequencefeature': {
            'Meta': {'object_name': 'DnaSequenceFeature'},
            'component': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sequenceFeatures'", 'to': "orm['rotmic.DnaComponent']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'rotmic.dnasequencelink': {
            'Meta': {'object_name': 'DnaSequenceLink'},
            'component': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sequenceLinks'", 'to': "orm['rotmic.DnaComponent']"}),
            'end': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'hardLink': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'strand': ('django.db.models.fields.CharField', [], {'default': "'+'", 'max_length': '1'}),
            'subComponent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'linkedVia'", 'null': 'True', 'to': "orm['rotmic.DnaComponent']"})
        },
        'rotmic.location': {
        ...
        'rotmic.proteinsequencefeature': {
            'Meta': {'object_name': 'ProteinSequenceFeature'},
            'component': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sequenceFeatures'", 'to': "orm['rotmic.ProteinComponent']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'end': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'featureType': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 4, 0, 0)'}),
        ...
        'rotmic.sampleprovenance': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provenanceType': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.SampleProvenanceType']", 'blank': 'True'}),
        ...
        'rotmic.sequencing': {
            ...
            'orderedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 4, 0, 0)'}),
