...
##        
        ...
        # Deleting field 'DnaComponent.insert'
        db.delete_column(u'rotmic_dnacomponent', 'insert_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DnaComponent.insert'
        db.add_column(u'rotmic_dnacomponent', 'insert',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='as_insert_in_dna', null=True, to=orm['rotmic.DnaComponent'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 13, 0, 0)', 'blank': 'True'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 13, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 13, 0, 0)'}),
        ...
        'rotmic.sequencing': {
            ...
            'orderedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 13, 0, 0)'}),
        ...
        'rotmic.userprofile': {
            ...
            'prefix': ('django.db.models.fields.CharField', [], {'default': "'id'", 'max_length': '5'}),
