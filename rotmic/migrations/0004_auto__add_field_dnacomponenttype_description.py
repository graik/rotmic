...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaComponentType.description'
        db.add_column(u'rotmic_dnacomponenttype', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaComponentType.description'
        db.delete_column(u'rotmic_dnacomponenttype', 'description')
