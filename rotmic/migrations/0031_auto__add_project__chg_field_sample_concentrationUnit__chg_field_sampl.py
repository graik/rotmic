...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registeredBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_created_by', to=orm['auth.User'])),
            ('registeredAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 20, 0, 0))),
            ('modifiedBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_modified_by', null=True, to=orm['auth.User'])),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 20, 0, 0))),
            ('displayId', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('rotmic', ['Project'])


        # Changing field 'Sample.concentrationUnit'
        db.alter_column(u'rotmic_sample', 'concentrationUnit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['rotmic.Unit']))

        # Changing field 'Sample.amountUnit'
        db.alter_column(u'rotmic_sample', 'amountUnit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['rotmic.Unit']))

        # Changing field 'ProteinComponent.componentType'
        db.alter_column(u'rotmic_proteincomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ProteinComponentType'], on_delete=models.PROTECT))
        # Adding M2M table for field projects on 'Component'
        m2m_table_name = db.shorten_name(u'rotmic_component_projects')
        ...
        db.create_unique(m2m_table_name, ['component_id', 'project_id'])


        # Changing field 'OligoComponent.componentType'
        db.alter_column(u'rotmic_oligocomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.OligoComponentType'], on_delete=models.PROTECT))

        # Changing field 'CellComponent.componentType'
        db.alter_column(u'rotmic_cellcomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.CellComponentType'], on_delete=models.PROTECT))

        # Changing field 'ChemicalComponent.componentType'
        db.alter_column(u'rotmic_chemicalcomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ChemicalType'], on_delete=models.PROTECT))

        # Changing field 'DnaComponent.vectorBackbone'
        db.alter_column(u'rotmic_dnacomponent', 'vectorBackbone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['rotmic.DnaComponent']))

        # Changing field 'DnaComponent.componentType'
        db.alter_column(u'rotmic_dnacomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.DnaComponentType'], on_delete=models.PROTECT))

        # Changing field 'DnaComponent.translatesTo'
        db.alter_column(u'rotmic_dnacomponent', 'translatesTo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rotmic.ProteinComponent']))

    def backwards(self, orm):
        # Deleting model 'Project'
        db.delete_table(u'rotmic_project')


        # Changing field 'Sample.concentrationUnit'
        db.alter_column(u'rotmic_sample', 'concentrationUnit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rotmic.Unit']))

        # Changing field 'Sample.amountUnit'
        db.alter_column(u'rotmic_sample', 'amountUnit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rotmic.Unit']))

        # Changing field 'ProteinComponent.componentType'
        db.alter_column(u'rotmic_proteincomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ProteinComponentType']))
        # Removing M2M table for field projects on 'Component'
        db.delete_table(db.shorten_name(u'rotmic_component_projects'))


        # Changing field 'OligoComponent.componentType'
        db.alter_column(u'rotmic_oligocomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.OligoComponentType']))

        # Changing field 'CellComponent.componentType'
        db.alter_column(u'rotmic_cellcomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.CellComponentType']))

        # Changing field 'ChemicalComponent.componentType'
        db.alter_column(u'rotmic_chemicalcomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ChemicalType']))

        # Changing field 'DnaComponent.vectorBackbone'
        db.alter_column(u'rotmic_dnacomponent', 'vectorBackbone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rotmic.DnaComponent']))

        # Changing field 'DnaComponent.componentType'
        db.alter_column(u'rotmic_dnacomponent', 'componentType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.DnaComponentType']))

        # Changing field 'DnaComponent.translatesTo'
        db.alter_column(u'rotmic_dnacomponent', 'translatesTo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rotmic.ProteinComponent']))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
        ...
        'rotmic.project': {
            'Meta': {'ordering': "('displayId',)", 'object_name': 'Project'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'displayId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
            'modifiedBy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_modified_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
