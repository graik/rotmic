...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OligoComponent.catalog'
        db.add_column(u'rotmic_oligocomponent', 'catalog',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30),
                      keep_default=False)

        # Adding field 'OligoComponent.link'
        db.add_column(u'rotmic_oligocomponent', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ChemicalComponent.catalog'
        db.add_column(u'rotmic_chemicalcomponent', 'catalog',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30),
                      keep_default=False)

        # Adding field 'ChemicalComponent.link'
        db.add_column(u'rotmic_chemicalcomponent', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OligoComponent.catalog'
        db.delete_column(u'rotmic_oligocomponent', 'catalog')

        # Deleting field 'OligoComponent.link'
        db.delete_column(u'rotmic_oligocomponent', 'link')

        # Deleting field 'ChemicalComponent.catalog'
        db.delete_column(u'rotmic_chemicalcomponent', 'catalog')

        # Deleting field 'ChemicalComponent.link'
        db.delete_column(u'rotmic_chemicalcomponent', 'link')
