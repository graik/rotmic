...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db.dry_run and orm['auth.User'].objects.all().count():
    ...
    def backwards(self, orm):
        # Deleting field 'Sample.preparedBy'
        db.delete_column(u'rotmic_sample', 'preparedBy_id')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 19, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 19, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 19, 0, 0)'}),
