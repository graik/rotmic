...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field markers on 'DnaComponent'
        m2m_table_name = db.shorten_name(u'rotmic_dnacomponent_markers')
        ...
        # Adding M2M table for field markers on 'CellComponent'
        m2m_table_name = db.shorten_name(u'rotmic_cellcomponent_markers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field markers on 'DnaComponent'
        db.delete_table(db.shorten_name(u'rotmic_dnacomponent_markers'))
        ...
        # Removing M2M table for field markers on 'CellComponent'
        db.delete_table(db.shorten_name(u'rotmic_cellcomponent_markers'))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
