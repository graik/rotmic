...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sample.source'
        db.delete_column(u'rotmic_sample', 'source')

        # Adding field 'Sample.experimentNr'
        db.add_column(u'rotmic_sample', 'experimentNr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sample.source'
        db.add_column(u'rotmic_sample', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sample.experimentNr'
        db.delete_column(u'rotmic_sample', 'experimentNr')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
