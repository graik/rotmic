...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Component.attachment'
        db.add_column(u'rotmic_component', 'attachment',
                      self.gf('rotmic.utils.filefields.DocumentModelField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Component.registeredBy'
        db.alter_column(u'rotmic_component', 'registeredBy_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Component.attachment'
        db.delete_column(u'rotmic_component', 'attachment')


        # Changing field 'Component.registeredBy'
        db.alter_column(u'rotmic_component', 'registeredBy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            'attachment': ('rotmic.utils.filefields.DocumentModelField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'displayId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 31, 0, 0)'}),
