...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaComponent.translatesTo'
        db.add_column(u'rotmic_dnacomponent', 'translatesTo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='codingSequences', null=True, to=orm['rotmic.ProteinComponent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaComponent.translatesTo'
        db.delete_column(u'rotmic_dnacomponent', 'translatesTo_id')
    ...
    models = {
        ...
        'rotmic.dnacomponent': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'planning'", 'max_length': '30'}),
            'translatesTo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'codingSequences'", 'null': 'True', 'to': "orm['rotmic.ProteinComponent']"}),
