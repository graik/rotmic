...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Container', fields ['displayId']
        db.delete_unique(u'rotmic_container', ['displayId'])

        # Adding field 'Container.rack'
        db.add_column(u'rotmic_container', 'rack',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='containers', to=orm['rotmic.Rack']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'rotmic_container', 'rack_id')

        # Adding unique constraint on 'Container', fields ['displayId']
        db.create_unique(u'rotmic_container', ['displayId'])
