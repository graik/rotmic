...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_sequencing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registeredBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequencing_created_by', to=orm['auth.User'])),
            ('registeredAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 24, 0, 0))),
            ('modifiedBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequencing_modified_by', null=True, to=orm['auth.User'])),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 24, 0, 0))),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequencing', to=orm['rotmic.DnaSample'])),
            ('orderedAt', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 24, 0, 0))),
            ('orderedBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sequencing', to=orm['auth.User'])),
            ('evaluation', self.gf('django.db.models.fields.CharField')(default='none', max_length=30)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('rotmic', ['Sequencing'])

        # Adding model 'SequencingRun'
        db.create_table(u'rotmic_sequencingrun', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('f', self.gf('rotmic.utils.filefields.DocumentModelField')(max_length=100, extensions=())),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='runs', to=orm['rotmic.Sequencing'])),
            ('primer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sequencingRun', null=True, to=orm['rotmic.OligoComponent'])),
        ))
        db.send_create_signal('rotmic', ['SequencingRun'])


    def backwards(self, orm):
        # Deleting model 'Sequencing'
        db.delete_table(u'rotmic_sequencing')

        # Deleting model 'SequencingRun'
        db.delete_table(u'rotmic_sequencingrun')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
        ...
        'rotmic.sequencing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'modifiedBy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sequencing_modified_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'orderedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
