...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaComponentType.isDefault'
        db.add_column(u'rotmic_dnacomponenttype', 'isDefault',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CellComponentType.isDefault'
        db.add_column(u'rotmic_cellcomponenttype', 'isDefault',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaComponentType.isDefault'
        db.delete_column(u'rotmic_dnacomponenttype', 'isDefault')

        # Deleting field 'CellComponentType.isDefault'
        db.delete_column(u'rotmic_cellcomponenttype', 'isDefault')
