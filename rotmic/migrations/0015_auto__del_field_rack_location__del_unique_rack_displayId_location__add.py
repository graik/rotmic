...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rack.location'
        db.delete_column(u'rotmic_rack', 'location_id')

        # Adding unique constraint on 'Rack', fields ['displayId']
        db.create_unique(u'rotmic_rack', ['displayId'])


    def backwards(self, orm):
        # Removing unique constraint on 'Rack', fields ['displayId']
        db.delete_unique(u'rotmic_rack', ['displayId'])

        # Adding field 'Rack.location'
        db.add_column(u'rotmic_rack', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.Location'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
        ...
        'rotmic.rack': {
            'Meta': {'ordering': "('location__displayId', 'displayId')", 'unique_together': "(('displayId',),)", 'object_name': 'Rack'},
            'displayId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
