...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OligoComponent.purification'
        db.add_column(u'rotmic_oligocomponent', 'purification',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=50),
                      keep_default=False)

        # Adding M2M table for field reversePrimers on 'OligoComponent'
        m2m_table_name = db.shorten_name(u'rotmic_oligocomponent_reversePrimers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_oligocomponent', models.ForeignKey(orm['rotmic.oligocomponent'], null=False)),
            ('to_oligocomponent', models.ForeignKey(orm['rotmic.oligocomponent'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_oligocomponent_id', 'to_oligocomponent_id'])


    def backwards(self, orm):
        # Deleting field 'OligoComponent.purification'
        db.delete_column(u'rotmic_oligocomponent', 'purification')

        # Removing M2M table for field reversePrimers on 'OligoComponent'
        db.delete_table(db.shorten_name(u'rotmic_oligocomponent_reversePrimers'))
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 23, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 23, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 23, 0, 0)'}),
