...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleProvenance.sample'
        db.add_column(u'rotmic_sampleprovenance', 'sample',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sampleParents', to=orm['rotmic.Sample']),
                      keep_default=False)

        # Adding field 'SampleProvenance.sourceSample'
        db.add_column(u'rotmic_sampleprovenance', 'sourceSample',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sampleChilds', null=True, to=orm['rotmic.Sample']),
                      keep_default=False)
