...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.container'
        db.add_column(u'rotmic_sample', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='samples', to=orm['rotmic.Container']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.container'
        db.delete_column(u'rotmic_sample', 'container_id')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
