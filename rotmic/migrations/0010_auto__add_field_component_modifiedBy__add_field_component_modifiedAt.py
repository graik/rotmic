...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Component.modifiedBy'
        db.add_column(u'rotmic_component', 'modifiedBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='component_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Component.modifiedAt'
        db.add_column(u'rotmic_component', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 10, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Component.modifiedBy'
        db.delete_column(u'rotmic_component', 'modifiedBy_id')

        # Deleting field 'Component.modifiedAt'
        db.delete_column(u'rotmic_component', 'modifiedAt')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 10, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 10, 0, 0)'}),
