...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SampleProvenance.sourceSample'
        db.delete_column(u'rotmic_sampleprovenance', 'sourceSample_id')

        # Deleting field 'SampleProvenance.sample'
        db.delete_column(u'rotmic_sampleprovenance', 'sample_id')


    def backwards(self, orm):
        # Adding field 'SampleProvenance.sourceSample'
        db.add_column(u'rotmic_sampleprovenance', 'sourceSample',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='derivedSample', null=True, to=orm['rotmic.Sample']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'SampleProvenance.sample'
        raise RuntimeError("Cannot reverse this migration. 'SampleProvenance.sample' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SampleProvenance.sample'
        db.add_column(u'rotmic_sampleprovenance', 'sample',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sampleProvenance', to=orm['rotmic.Sample']),
                      keep_default=False)
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
