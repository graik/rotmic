...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProteinSample'
        db.create_table(u'rotmic_proteinsample', (
            (u'sample_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rotmic.Sample'], unique=True, primary_key=True)),
            ('protein', self.gf('django.db.models.fields.related.ForeignKey')(related_name='protein_samples', to=orm['rotmic.ProteinComponent'])),
        ))
        db.send_create_signal('rotmic', ['ProteinSample'])


    def backwards(self, orm):
        # Deleting model 'ProteinSample'
        db.delete_table(u'rotmic_proteinsample')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 14, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 14, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 14, 0, 0)'}),
