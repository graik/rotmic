...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellComponentType.allowPlasmids'
        db.add_column(u'rotmic_cellcomponenttype', 'allowPlasmids',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CellComponentType.allowPlasmids'
        db.delete_column(u'rotmic_cellcomponenttype', 'allowPlasmids')
