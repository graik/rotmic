...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaComponent.genbank'
        db.add_column(u'rotmic_dnacomponent', 'genbank',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaComponent.genbank'
        db.delete_column(u'rotmic_dnacomponent', 'genbank')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 16, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 16, 0, 0)'}),
