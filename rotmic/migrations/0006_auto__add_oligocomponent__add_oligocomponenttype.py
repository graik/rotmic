...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OligoComponent'
        db.create_table(u'rotmic_oligocomponent', (
            ...
            ('sequence', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('componentType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.OligoComponentType'])),
            ('meltingTemp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('rotmic', ['OligoComponent'])

        # Adding M2M table for field templates on 'OligoComponent'
        m2m_table_name = db.shorten_name(u'rotmic_oligocomponent_templates')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oligocomponent', models.ForeignKey(orm['rotmic.oligocomponent'], null=False)),
            ('dnacomponent', models.ForeignKey(orm['rotmic.dnacomponent'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oligocomponent_id', 'dnacomponent_id'])

        # Adding model 'OligoComponentType'
        db.create_table(u'rotmic_oligocomponenttype', (
        ...
        db.send_create_signal('rotmic', ['OligoComponentType'])


    def backwards(self, orm):
        # Deleting model 'OligoComponent'
        db.delete_table(u'rotmic_oligocomponent')

        # Removing M2M table for field templates on 'OligoComponent'
        db.delete_table(db.shorten_name(u'rotmic_oligocomponent_templates'))

        # Deleting model 'OligoComponentType'
        db.delete_table(u'rotmic_oligocomponenttype')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
