...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rotmic_dnacomponent', 'circular')


    def backwards(self, orm):
        # Adding field 'DnaComponent.circular'
        db.add_column(u'rotmic_dnacomponent', 'circular',
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
