...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 17, 0, 0)'}),
        ...
        'rotmic.dnacomponent': {
            ...
            'componentType': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'Type'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['rotmic.DnaComponentType']"}),
