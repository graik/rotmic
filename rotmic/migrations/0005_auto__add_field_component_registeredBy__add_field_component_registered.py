...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rotmic_component', 'registeredAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 13, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
