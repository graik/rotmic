...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChemicalSample'
        db.create_table(u'rotmic_chemicalsample', (
            (u'sample_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rotmic.Sample'], unique=True, primary_key=True)),
            ('chemical', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chemical_samples', to=orm['rotmic.ChemicalComponent'])),
        ))
        db.send_create_signal('rotmic', ['ChemicalSample'])


    def backwards(self, orm):
        # Deleting model 'ChemicalSample'
        db.delete_table(u'rotmic_chemicalsample')
