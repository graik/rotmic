...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_chemicalcomponent', (
            ...
            ('componentType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.ChemicalType'])),
            ('cas', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('rotmic', ['ChemicalComponent'])

        # Adding model 'ChemicalType'
        db.create_table(u'rotmic_chemicaltype', (
            ...
            ('subTypeOf', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subTypes', null=True, to=orm['rotmic.ChemicalType'])),
        ))
        db.send_create_signal('rotmic', ['ChemicalType'])


    def backwards(self, orm):
        # Deleting model 'ChemicalComponent'
        db.delete_table(u'rotmic_chemicalcomponent')

        # Deleting model 'ChemicalType'
        db.delete_table(u'rotmic_chemicaltype')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
