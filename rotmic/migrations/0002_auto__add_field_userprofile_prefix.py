...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.prefix'
        db.add_column(u'rotmic_userprofile', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='mt', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.prefix'
        db.delete_column(u'rotmic_userprofile', 'prefix')
    ...
    models = {
        ...
        'rotmic.userprofile': {
            ...
            'ccPrefix': ('django.db.models.fields.CharField', [], {'default': "'mt'", 'max_length': '5', 'blank': 'True'}),
            'dcPrefix': ('django.db.models.fields.CharField', [], {'default': "'mt'", 'max_length': '5', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
