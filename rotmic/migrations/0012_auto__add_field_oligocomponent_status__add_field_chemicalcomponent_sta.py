...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OligoComponent.status'
        db.add_column(u'rotmic_oligocomponent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='available', max_length=30),
                      keep_default=False)

        # Adding field 'ChemicalComponent.status'
        db.add_column(u'rotmic_chemicalcomponent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='available', max_length=30),
                      keep_default=False)

        # Adding field 'DnaComponent.status'
        db.add_column(u'rotmic_dnacomponent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='planning', max_length=30),
                      keep_default=False)

        # Adding field 'CellComponent.status'
        db.add_column(u'rotmic_cellcomponent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='planning', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OligoComponent.status'
        db.delete_column(u'rotmic_oligocomponent', 'status')

        # Deleting field 'ChemicalComponent.status'
        db.delete_column(u'rotmic_chemicalcomponent', 'status')

        # Deleting field 'DnaComponent.status'
        db.delete_column(u'rotmic_dnacomponent', 'status')

        # Deleting field 'CellComponent.status'
        db.delete_column(u'rotmic_cellcomponent', 'status')
    ...
    models = {
        ...
        'rotmic.chemicaltype': {
            'Meta': {'ordering': "['name']", 'object_name': 'ChemicalType'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)'}),
