...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_sample', (
            ...
            ('registeredAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 17, 0, 0))),
            ('modifiedBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sample_modified_by', null=True, to=orm['auth.User'])),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 17, 0, 0))),
            ...
            ('preparedAt', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 17, 0, 0))),
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
